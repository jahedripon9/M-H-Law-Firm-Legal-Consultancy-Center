        ...
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem] ">
          ...
          >
            ...
            <a
              ...
              aria-current="page"
              className="flex items-center gap-2 py-3 text-xs font-bold sm:text-2xl whitespace-nowrap focus:outline-none lg:flex-1"
